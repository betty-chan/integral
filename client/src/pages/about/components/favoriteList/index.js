            ...
            <main>
                <div className={Style['favorite-list']}>
                    <ul className="favorite-nav">
                        <li className={this.state.tag == 1 ? "active" : ""} onClick={() => this.setState({ tag: 1 })}><i className="topic"></i>帖子</li>
                        <li className={this.state.tag == 2 ? "active" : ""} onClick={() => this.setState({ tag: 2 })}><i className="collect"></i>收藏夹</li>
                    </ul>
