                ...
                <div className={Style['user-infos']}>
                    ...
                    <div className="user-infos">
                        ...
                        <p className="attention-status">
                            <span>帖子<b>{this.props.personalInfo.topicCounts}</b></span>
                            <span>粉丝<b>{this.props.personalInfo.fansCounts}</b></span>
                            <span><b>关注</b>{this.props.personalInfo.followCounts}</span>
                        </p>
